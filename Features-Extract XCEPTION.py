...
extract_features('/home/sivamurugan/deep-learning-models-master/XCEPTION/XCEPTION/train.h5', train_dir, key='train', 
                                    sample_count='all', batch_size=100, target_size=(299,299))

extract_features('/home/sivamurugan/deep-learning-models-master/XCEPTION/XCEPTION/val.h5', validation_dir, key='val', 
                                    sample_count='all', batch_size=100, target_size=(299,299))
