...
train_steps_per_epoch, train_generator = features_from_file('/home/sivamurugan/deep-learning-models-master/INCEPTIONRESNET/train-ALL.h5', 'train')
validation_steps, validation_data = features_from_file('/home/sivamurugan/deep-learning-models-master/INCEPTIONRESNET/val-ALL.h5', 'val')

np.random.seed(7)
inputs = Input(shape=(8, 8, 1536))
...
callbacks = [ 
    ModelCheckpoint('/home/sivamurugan/deep-learning-models-master/INCEPTIONRESNET/model.features.{epoch:02d}-{val_acc:.2f}.hdf5', 
