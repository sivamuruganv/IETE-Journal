...
conv_base =DenseNet169(weights='imagenet', include_top=False)
...
extract_features('/home/sivamurugan/deep-learning-models-master/DENSENET/169/169/train.h5', train_dir, key='train', 
                                    sample_count='all', batch_size=100, target_size=(224,224))

extract_features('/home/sivamurugan/deep-learning-models-master/DENSENET/169/169/val.h5', validation_dir, key='val', 
                                    sample_count='all', batch_size=100, target_size=(224,224))
