...
train_steps_per_epoch, train_generator = features_from_file('/home/sivamurugan/deep-learning-models-master/XCEPTION/XCEPTION/train-ALL.h5', 'train')
validation_steps, validation_data = features_from_file('/home/sivamurugan/deep-learning-models-master/XCEPTION/XCEPTION/val-ALL.h5', 'val')

np.random.seed(7)
inputs = Input(shape=(10,10, 2048))
...
callbacks = [ 
    ModelCheckpoint('/home/sivamurugan/deep-learning-models-master/XCEPTION/XCEPTION/model.features.{epoch:02d}-{val_acc:.2f}.hdf5', 
