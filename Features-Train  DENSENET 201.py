...
train_steps_per_epoch, train_generator = features_from_file('/home/sivamurugan/deep-learning-models-master/DENSENET/201/201/train-ALL.h5', 'train')
validation_steps, validation_data = features_from_file('/home/sivamurugan/deep-learning-models-master/DENSENET/201/201/val-ALL.h5', 'val')

np.random.seed(7)
inputs = Input(shape=(7, 7, 1920))
...
callbacks = [ 
    ModelCheckpoint('/home/sivamurugan/deep-learning-models-master/DENSENET/201/201/model.features.{epoch:02d}-{val_acc:.2f}.hdf5', 
