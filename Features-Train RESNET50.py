...
train_steps_per_epoch, train_generator = features_from_file('/home/sivamurugan/deep-learning-models-master/RESNET50/50/50/train-ALL.h5', 'train')
validation_steps, validation_data = features_from_file('/home/sivamurugan/deep-learning-models-master/RESNET50/50/50/val-ALL.h5', 'val')
...
callbacks = [ 
    ModelCheckpoint('/home/sivamurugan/deep-learning-models-master/RESNET50/50/50/model.features.{epoch:02d}-{val_acc:.2f}.hdf5', 
...
def plot_history(history):
    ...
    plt.plot(epochs, acc, 'b',color='green',  label='Training Accuracy')
