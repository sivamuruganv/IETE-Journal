...
train_steps_per_epoch, train_generator = features_from_file('/home/sivamurugan/deep-learning-models-master/INCEPTION/INCEPTION/train-ALL.h5', 'train')
validation_steps, validation_data = features_from_file('/home/sivamurugan/deep-learning-models-master/INCEPTION/INCEPTION/val-ALL.h5', 'val')
...
callbacks = [ 
    ModelCheckpoint('/home/sivamurugan/deep-learning-models-master/INCEPTION/INCEPTION/model.features.{epoch:02d}-{val_acc:.2f}.hdf5', 
